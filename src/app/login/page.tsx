      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-xl space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center py-3.5 rounded-xl font-bold text-xs text-slate-700 bg-white hover:bg-slate-50 border border-slate-200 transition-all shadow-sm"
          >
